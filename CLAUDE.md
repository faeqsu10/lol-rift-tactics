...
- Current active native tracks:
  ...
  - `native_tactics`: 3인 선택 -> 시작 배치 -> 3전 원정 -> 보상 -> 전투 요약 -> 3안 경로+런 노드 선택 + 전투 이벤트 -> 패시브 2차/챔피언별 특수기/적 의도 4차/연속 턴 예고/지형/엘리트 특성/보스 결전/보스 전용 목표/결전 각성 연출/맵 목표/목표 경쟁 AI/실패 페널티/휴식·변수·정예 노드 분기 -> 런 종료 결산/즉시 새 원정

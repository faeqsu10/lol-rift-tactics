    ...
    ChampionBlueprint(
        ...
        abilities=(
            Ability(
                id="frost-shot",
                name="서리 화살",
                description="차가운 화살로 적 하나를 꿰뚫습니다.",
                cooldown=1,
                target_type="enemy",
                effects=(AbilityEffect(kind="damage", amount=15),),
            ),
            Ability(
                id="volley",
                name="일제 사격",
                description="화살 세례로 적 전체를 억제합니다.",
                cooldown=3,
                target_type="all-enemies",
                effects=(AbilityEffect(kind="damage", amount=10),),
            ),
            Ability(
                id="enchanted-crystal-arrow",
                name="마법의 수정화살",
                description="거대한 수정화살로 적을 기절시키고 마무리합니다.",
                cooldown=4,
                target_type="enemy",
                effects=(
                    AbilityEffect(kind="damage", amount=14),
                    AbilityEffect(kind="stun", turns=1),
                ),
            ),
        ),
    ...
    ChampionBlueprint(
        ...
        abilities=(
            Ability(
                id="winters-bite",
                name="동상",
                description="냉기의 충격으로 적을 멈춰 세웁니다.",
                cooldown=2,
                target_type="enemy",
                effects=(
            ...
            Ability(
                id="unbreakable",
                name="불굴",
                description="거대한 방패를 세워 두터운 보호막을 얻습니다.",
                cooldown=2,
                target_type="self",
                effects=(AbilityEffect(kind="shield", amount=24),),
            ),
            Ability(
                id="glacial-fissure",
                name="빙하 균열",
                description="대지를 갈라 적 전체를 강하게 흔듭니다.",
                cooldown=4,
                target_type="all-enemies",
                effects=(AbilityEffect(kind="damage", amount=11),),
            ),
    ...
    ChampionBlueprint(
        ...
        abilities=(
            Ability(
                id="broken-wings",
                name="부러진 날개",
                description="연속된 검격으로 적 하나를 베어냅니다.",
                cooldown=1,
                target_type="enemy",
                effects=(AbilityEffect(kind="damage", amount=17),),
            ),
            Ability(
                id="valor",
                name="용맹",
                description="순간적으로 몸을 빼며 보호막을 얻습니다.",
                cooldown=2,
                target_type="self",
                effects=(AbilityEffect(kind="shield", amount=16),),
            ),
            Ability(
                id="wind-slash",
                name="윈드 슬래시",
                description="룬 검기를 날려 적 전열을 크게 베어냅니다.",
                cooldown=4,
                target_type="all-enemies",
                effects=(AbilityEffect(kind="damage", amount=13),),
            ),
    ...
    ChampionBlueprint(
        ...
        abilities=(
            Ability(
                id="command-attack",
                name="명령: 공격",
                description="구체를 날려 적 하나를 강하게 타격합니다.",
                cooldown=1,
                target_type="enemy",
                effects=(AbilityEffect(kind="damage", amount=16),),
            ),
            Ability(
                id="command-protect",
                name="명령: 보호",
                description="구체의 장막으로 자신을 감싸 보호막을 얻습니다.",
                cooldown=2,
                target_type="self",
                effects=(AbilityEffect(kind="shield", amount=18),),
            ),
            Ability(
                id="shockwave",
                name="충격파",
                description="구체를 폭발시켜 적 전체를 끌어당기듯 뒤흔듭니다.",
                cooldown=4,
                target_type="all-enemies",
                effects=(AbilityEffect(kind="damage", amount=12),),
            ),
...
RED_TEAM: tuple[ChampionBlueprint, ...] = (
    ...
    ChampionBlueprint(
        ...
        abilities=(
            Ability(
                id="bouncing-blade",
                name="단검 투척",
                description="날렵한 단검으로 적 하나를 베어냅니다.",
                cooldown=1,
                target_type="enemy",
                effects=(AbilityEffect(kind="damage", amount=16),),
            ),
            Ability(
                id="preparation",
                name="준비",
                description="몸을 낮추고 빈틈을 지워 보호막을 얻습니다.",
                cooldown=2,
                target_type="self",
                effects=(AbilityEffect(kind="shield", amount=14),),
            ),
            Ability(
                id="death-lotus",
                name="죽음의 연꽃",
                description="회전하는 칼날 폭풍으로 적 전체를 갈아냅니다.",
                cooldown=4,
                target_type="all-enemies",
                effects=(AbilityEffect(kind="damage", amount=13),),
            ),
    ...
    ChampionBlueprint(
        ...
        abilities=(
            Ability(
                id="pillar-of-flame",
                name="불기둥",
                description="타오르는 화염 기둥으로 적 하나를 태웁니다.",
                cooldown=1,
                target_type="enemy",
                effects=(AbilityEffect(kind="damage", amount=16),),
            ),
            Ability(
                id="sear",
                name="불태우기",
                description="불꽃 탄환으로 적을 기절시키고 압박합니다.",
                cooldown=2,
                target_type="enemy",
                effects=(
                    AbilityEffect(kind="damage", amount=9),
            ...
            Ability(
                id="pyroclasm",
                name="파멸의 불덩이",
                description="연쇄 폭발 화염으로 적 전체를 태워버립니다.",
                cooldown=4,
                target_type="all-enemies",
                effects=(AbilityEffect(kind="damage", amount=14),),
            ),
    ...
    ChampionBlueprint(
        ...
        abilities=(
            Ability(
                id="five-point-strike",
                name="오연투척검",
                description="날카로운 검기를 던져 적 하나를 벱니다.",
                cooldown=1,
                target_type="enemy",
                effects=(AbilityEffect(kind="damage", amount=16),),
            ),
            Ability(
                id="twilight-shroud",
                name="황혼의 장막",
                description="연막 속으로 숨어 보호막을 얻습니다.",
                cooldown=2,
                target_type="self",
                effects=(AbilityEffect(kind="shield", amount=16),),
            ),
            Ability(
                ...
                name="무결처형",
                description="표식을 새기며 적 하나를 꿰뚫는 처형 돌진입니다.",
                cooldown=3,
                target_type="enemy",
                effects=(AbilityEffect(kind="damage", amount=24),),
            ),
    ...
    ChampionBlueprint(
        ...
        abilities=(
            Ability(
                id="knuckle-down",
                name="주먹다짐",
                description="강한 주먹 연계로 적 하나를 몰아붙입니다.",
                cooldown=1,
                target_type="enemy",
                effects=(AbilityEffect(kind="damage", amount=19),),
            ),
            Ability(
                id="haymaker",
                name="강펀치",
                description="버티며 힘을 모아 자신에게 보호막을 부여합니다.",
                cooldown=2,
                target_type="self",
                effects=(AbilityEffect(kind="shield", amount=22),),
            ),
            Ability(
                id="show-stopper",
                name="대미장식",
                description="적을 붙잡아 바닥에 메다꽂고 기절시킵니다.",
                cooldown=4,
                target_type="enemy",
                effects=(
                    AbilityEffect(kind="damage", amount=23),
                    AbilityEffect(kind="stun", turns=1),
                ),
            ),
        ),
